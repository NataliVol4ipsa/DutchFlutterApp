...
class BorderStyles {
  static InputDecorationThemeData inputDecorationTheme(BuildContext context) =>
  ...
  static BorderRadius bigBorderRadius = BorderRadius.circular(
    bigBorderRadiusValue,
  );
