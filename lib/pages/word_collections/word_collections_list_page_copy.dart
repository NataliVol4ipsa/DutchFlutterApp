...
class WordCollectionsListPageOld extends StatefulWidget {
  const WordCollectionsListPageOld({super.key});

  @override
  State<WordCollectionsListPageOld> createState() =>
      _WordCollectionsListPageOldState();
}

Widget customPadding() => const SizedBox(height: 10);

class _WordCollectionsListPageOldState
    extends State<WordCollectionsListPageOld> {
