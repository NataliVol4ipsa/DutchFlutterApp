...
class PastTenseIkInput extends StatelessWidget {
  final TextEditingController textEditingController;

  const PastTenseIkInput({super.key, required this.textEditingController});
  ...
  Widget build(BuildContext context) {
    return PaddedFormComponent(
      child: FormTextInput(
        ...
        inputLabel: "Verleden tijd - Ik",
        hintText: "Verleden tijd - Ik",
        isRequired: false,
