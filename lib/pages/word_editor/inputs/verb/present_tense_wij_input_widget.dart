...
class PresentTenseWijInput extends StatelessWidget {
  final TextEditingController textEditingController;

  const PresentTenseWijInput({super.key, required this.textEditingController});
  ...
  Widget build(BuildContext context) {
    return PaddedFormComponent(
      child: FormTextInput(
        ...
        inputLabel: "Tegenwoordige tijd - Wij",
        hintText: "Tegenwoordige tijd - Wij",
        isRequired: false,
