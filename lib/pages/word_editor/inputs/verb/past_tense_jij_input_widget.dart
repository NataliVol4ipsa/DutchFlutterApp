...
class PastTenseJijInput extends StatelessWidget {
  final TextEditingController textEditingController;

  const PastTenseJijInput({super.key, required this.textEditingController});
  ...
  Widget build(BuildContext context) {
    return PaddedFormComponent(
      child: FormTextInput(
        ...
        inputLabel: "Verleden tijd - Jij",
        hintText: "Verleden tijd - Jij",
        isRequired: false,
