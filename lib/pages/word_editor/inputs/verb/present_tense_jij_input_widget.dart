...
class PresentTenseJijInput extends StatelessWidget {
  final TextEditingController textEditingController;

  const PresentTenseJijInput({super.key, required this.textEditingController});
  ...
  Widget build(BuildContext context) {
    return PaddedFormComponent(
      child: FormTextInput(
        ...
        inputLabel: "Tegenwoordige tijd - Jij",
        hintText: "Tegenwoordige tijd - Jij",
        isRequired: false,
