...
class PresentTenseHijZijHetInput extends StatelessWidget {
  final TextEditingController textEditingController;

  const PresentTenseHijZijHetInput(
  ...
  Widget build(BuildContext context) {
    return PaddedFormComponent(
      child: FormTextInput(
        ...
        inputLabel: "Tegenwoordige tijd - Hij/Zij/Het",
        hintText: "Tegenwoordige tijd - Hij/Zij/Het",
        isRequired: false,
