...
class InfinitiveInput extends StatelessWidget {
  final TextEditingController textEditingController;

  const InfinitiveInput({super.key, required this.textEditingController});
  ...
  Widget build(BuildContext context) {
    return PaddedFormComponent(
      child: FormTextInput(
        ...
        inputLabel: "Infinitief",
        hintText: "Infinitief",
        isRequired: false,
        prefixIcon: FormInputIcon(InputIcons.infinitive),
      ),
    );
  }
}
