...
class ContextExampleInput extends StatelessWidget {
  final TextEditingController textEditingController;

  const ContextExampleInput({super.key, required this.textEditingController});
  ...
  Widget build(BuildContext context) {
    return PaddedFormComponent(
      child: FormTextInput(
        ...
        inputLabel: "Example in sentence",
        hintText: "Example in sentence",
        isRequired: false,
        prefixIcon: FormInputIcon(InputIcons.contextExample),
      ),
    );
  }
}
